...
void dummy_two(StateMachine* state_machine) {
    ...
    state_machine->undefine(THREE);
    cout << "Dummy Two undefined Three, total " << (int) state_machine->defined() << endl;
    state_machine->next();
...
int main(int argc, char* argv[]) {
    ...
    require(dummy_two_call_count == 3);
    require(dummy_three_call_count == 0);
    require(state_machine.getCurrentId() == 1);
    return EXIT_SUCCESS;
}
